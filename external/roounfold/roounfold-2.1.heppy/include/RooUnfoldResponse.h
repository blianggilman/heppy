...
public:
  ...
  // Fill with data and corresponding errors

  virtual Int_t FillContentError (Double_t xr, Double_t xt, Double_t w, Double_t err);  // Fill 1D Response Matrix with weight w and error err
  virtual Int_t FillContentError (Double_t xr, Double_t yr, Double_t xt, Double_t yt, Double_t w, Double_t err);  // Fill 2D Response Matrix with weight w and error err
  virtual Int_t FillContentError (Double_t xr, Double_t yr, Double_t zr, Double_t xt, Double_t yt, Double_t zt, Double_t w, Double_t err);  // Fill 3D Response Matrix with weight w and error err
